...
Drones:
  - Follow purposeful patrol routes between local landmarks
  - Return to base when battery drops below threshold
...
or from environment variables:
    ...
    MAP_LOCATION_NAME          – display name for the demo location (default: Denver, CO)
    MAP_CENTER_LAT             – map center latitude (default: 39.7484)
    MAP_CENTER_LON             – map center longitude (default: -104.9951)
    MAP_BASE_LAT               – drone base latitude (default: 39.7437)
    MAP_BASE_LON               – drone base longitude (default: -104.9916)
...
# Base / home pad
BASE_LAT, BASE_LON = (
    float(os.getenv("MAP_BASE_LAT", "39.7437")),
    float(os.getenv("MAP_BASE_LON", "-104.9916")),
)
